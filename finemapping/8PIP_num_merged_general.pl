#!/usr/bin/perl -w
use strict;
#my $folder="sc_human_retina/data/GWAS/SummaryStat/Hysi_32231278/Hysi_32231278NG/Hysi_sig_snp_1000g_flt_merged_other/";
#my $folder = "sc_human_retina/data/GWAS/SummaryStat/$ARGV[0]";
my $folder = "$ARGV[0]";
#my $folder = "sc_human_retina/data/GWAS/SummaryStat/Hysi_32231278/Hysi_32231278NG/Hysi_Choquet_Khawaja_et_al_Refracive_Error_NatGenet_2020_MAF0.01_5e8_format.vcf.1000g_flt_20ppl_other";
#my $output1 = "sc_human_retina/data/cell_atlas/Hysi_32231278_pip_total_merged";
#my $output = "sc_human_retina/data/cell_atlas/Hysi_32231278_cs_size_merged";
#my $output2 = "sc_human_retina/data/cell_atlas/Hysi_32231278_pip_var_all_merged";

my $output1 = "sc_human_retina/data/cell_atlas/$ARGV[1]"."_pip_total_merged";
my $output = "sc_human_retina/data/cell_atlas/$ARGV[1]"."_cs_size_merged";
my $output2 = "sc_human_retina/data/cell_atlas/$ARGV[1]"."_pip_var_all_merged";
